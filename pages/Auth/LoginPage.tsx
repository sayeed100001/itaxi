        ...
        try {
            const response = await fetch(`${API_BASE}/auth/request-otp`, {
                ...
                body: JSON.stringify({ 
                    ...
                    role: authType === 'signup' ? selectedRole : undefined 
                }),
            });
            ...
            if (data.success) {
                ...
                if (data.data?.otp) {
                    addToast('info', `کد ورود (برای تست): ${data.data.otp}`);
                }
                setStep('otp');
            } else {
    ...
    const handleVerifyOtp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success && data.data?.token && data.data?.user) {
                ...
                setRole(data.data.user.role as any);
                setUser({
                ...
                addToast('error', data.message || 'Invalid OTP');
            }
        } catch (error) {
                    ...
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {[
                                ...
                                <button
                                    key={r.id}
                                    onClick={() => setSelectedRole(r.id as 'RIDER' | 'DRIVER')}
